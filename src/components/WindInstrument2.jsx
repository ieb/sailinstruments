  ...
  render() {
    return (
        <div className="instrumentContainer"  >
            <CompassRose northup={this.state.northup} app={this.app} updaterate={this.state.updaterate} width="620" height="620" />
            <BoatRose headup={!this.state.northup} app={this.app} updaterate={this.state.updaterate} width="620" height="620" />
